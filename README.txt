mvn archetype:generate -DgroupId=spring.authentication -DartifactId=spring.authentication.basic -DarchetypeArtifactId=maven-archetype-webapp -DinteractiveMode=false
